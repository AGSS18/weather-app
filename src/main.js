...
let actualHour;
let actualMinutes;
let multipleConditions = ["Mist", "Smoke", "Haze", "Dust", "Fog", "Sand", "Ash", "Squal", "Tornado"];
let otherConditions = ["Clear", "Clouds", "Snow", "Drizzle", "Rain"];
let otherConditionsIcons = [`<i class="fas fa-sun"></i>`, `<i class="fas fa-cloud"></i>`, `<i class="fas fa-snowflake"></i>`, `<i class="fas fa-cloud-showers-heavy"></i>`, `<i class="fas fa-cloud-rain"></i>`];
...
function searchForm(Event){
  ...
  let cityValue = valueSearch.value;
  let updateCity = document.querySelector("#city");
  updateCity.innerHTML = cityValue;
...
function showWeather(response) {
  ...
  let roundMainTemp = Math.round(response.data.main.temp);
